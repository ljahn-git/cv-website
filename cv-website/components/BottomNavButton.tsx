...
export default function BottomNavButton({ currentPage, onClick }: BottomNavButtonProps) {
    return (
        <div>
            {currentPage == 0 ? <button onClick={onClick} className="absolute bottom-0 left-0 right-0 w-full h-12 flex p-1 items-center justify-center cursor-pointer hover:bg-gray-300 hover:italic hover:border-t-2 border-black">
