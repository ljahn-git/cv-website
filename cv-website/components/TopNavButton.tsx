...
export default function TopNavButton({ currentPage, onClick }: TopNavButtonProps) {
    return (
        <div>
        {currentPage == 2 ? <button onClick={onClick} className="absolute top-0 left-0 right-0 w-full h-12 flex p-1 items-center justify-center cursor-pointer hover:bg-red-300 font-bold hover:italic hover:border-b-2 border-black">
