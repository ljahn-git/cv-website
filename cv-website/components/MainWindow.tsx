...
export default function MainWindow({ currentPage }: MainWindowProps) {
    return(
        <div className="relative flex h-screen justify-center items-center bg-red-400">
            <div className={`overflow-y-scroll z-10 animate-move-up w-4/5 h-4/5 m-8 sm:px-8 px-2 py-9 bg-white border border-8 rounded-4xl 2xl:border-red-500 xl:border-black lg:border-green-500 md:border-yellow-300 sm:border-red-500`}> {/*${currentPage == 0 ? "border-red-300" : ""} */}
